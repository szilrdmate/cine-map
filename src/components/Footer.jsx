...
const Footer = () => {
  ...
  return (
    <div className="md:flex justify-center bg-white w-screen z-10 absolute bottom-0 left-0 h-12 hidden">
      ...
      <div className="w-[calc(100vw-64px)] bg-teal-950 absolute bottom-8 h-32 z-10 rounded-b-2xl md:overflow-x-scroll md:flex items-center space-x-4 px-4">
      <div className="w-32">
      ...
      <div className="w-40 h-10 left-8 bottom-40 bg-teal-950 absolute z-10 rounded-tr-2xl md:flex items-center justify-center"><a className="text-white font-semibold text-2xl" href="/favorites">Favorites</a></div>
    </div>
  );
};
